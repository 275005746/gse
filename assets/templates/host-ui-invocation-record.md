...
- Lifecycle stage: none | recommended | acknowledged | dispatched | completed
- Packet ID:
- Top-level Plan Unit ID:
- Slice ID:
- Lifecycle timestamp:
- Continuation evidence refs:
- Host dispatch observed: false (derived; true only for dispatched or completed)
