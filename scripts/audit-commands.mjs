...
const checks = [
  ...
  check('CMD08', 'short CLI wrapper exists and is documented', exists('scripts/gse.mjs') && skill.includes('scripts/gse.mjs') && commands.includes('scripts/gse.mjs') && read('README.md').includes('gse status --target .') && read('README.md').includes('gse continue --target .') && read('README.zh-CN.md').includes('gse status --target .') && read('README.zh-CN.md').includes('gse continue --target .'), 'scripts/gse.mjs, SKILL.md, README.md, README.zh-CN.md, references/commands.md'),
