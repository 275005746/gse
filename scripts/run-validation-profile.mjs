...
function commandList(selectedProfile) {
  const common = [
    ...
    ['audit-product-boundary.mjs', ['--root', root, '--target', target, '--json']],
    ...
    ['audit-command-adapters.mjs', ['--root', root, '--json']],
    ['audit-host-runtime-invocations.mjs', ['--root', root, '--json']],
    ['audit-host-runtime-invocation-drill.mjs', ['--root', root, '--json']],
